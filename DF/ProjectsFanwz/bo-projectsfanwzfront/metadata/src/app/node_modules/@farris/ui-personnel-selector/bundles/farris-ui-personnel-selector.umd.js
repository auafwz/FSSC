(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-datagrid-editors'), require('@angular/platform-browser'), require('@angular/cdk/drag-drop'), require('@angular/common'), require('@angular/common/http'), require('@angular/forms'), require('@farris/ui-avatar'), require('@farris/ui-common'), require('@farris/ui-datagrid'), require('@farris/ui-dialog'), require('@farris/ui-forms'), require('@farris/ui-input-group'), require('@farris/ui-list-view'), require('@farris/ui-locale'), require('@farris/ui-messager'), require('@farris/ui-modal'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-switch'), require('@farris/ui-tabs'), require('@farris/ui-text'), require('@farris/ui-tree'), require('@farris/ui-treetable'), require('@farris/ui-loading'), require('@farris/ui-combo-list'), require('@angular/core'), require('@farris/ui-notify'), require('rxjs/operators'), require('rxjs'), require('lodash-es')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-personnel-selector', ['exports', '@farris/ui-datagrid-editors', '@angular/platform-browser', '@angular/cdk/drag-drop', '@angular/common', '@angular/common/http', '@angular/forms', '@farris/ui-avatar', '@farris/ui-common', '@farris/ui-datagrid', '@farris/ui-dialog', '@farris/ui-forms', '@farris/ui-input-group', '@farris/ui-list-view', '@farris/ui-locale', '@farris/ui-messager', '@farris/ui-modal', '@farris/ui-perfect-scrollbar', '@farris/ui-switch', '@farris/ui-tabs', '@farris/ui-text', '@farris/ui-tree', '@farris/ui-treetable', '@farris/ui-loading', '@farris/ui-combo-list', '@angular/core', '@farris/ui-notify', 'rxjs/operators', 'rxjs', 'lodash-es'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-personnel-selector'] = {}),global.uiDatagridEditors,global.ng.platformBrowser,global.ng.cdk['drag-drop'],global.ng.common,global.ng.common.http,global.ng.forms,global['@farris/ui-avatar'],global['@farris/ui-common'],global['@farris/ui-datagrid'],global['@farris/ui-dialog'],global['@farris/ui-forms'],global['@farris/ui-input-group'],global['@farris/ui-list-view'],global['@farris/ui-locale'],global.uiMessager,global['@farris/ui-modal'],global['@farris/ui-perfect-scrollbar'],global['@farris/ui-switch'],global['@farris/ui-tabs'],global['@farris/ui-text'],global['@farris/ui-tree'],global['@farris/ui-treetable'],global.uiLoading,global.uiComboList,global.ng.core,global.uiNotify,global.rxjs.operators,global.rxjs,global._));
}(this, (function (exports,uiDatagridEditors,platformBrowser,dragDrop,common,http,forms,uiAvatar,uiCommon,uiDatagrid,uiDialog,uiForms,uiInputGroup,uiListView,uiLocale,uiMessager,uiModal,uiPerfectScrollbar,uiSwitch,uiTabs,uiText,uiTree,uiTreetable,uiLoading,uiComboList,i0,uiNotify,operators,rxjs,_) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PersonnelSelectorComponent = /** @class */ (function () {
        function PersonnelSelectorComponent(apiService, injector, favoritesTool, eventManager, groupTool, cd) {
            ...
            this.draggable = true;
            // 组织id
            // 测试数据1（平台与技术部）：bbb8986b-f49f-bdb4-e620-929495d5e993
            // 测试数据1（浪潮国际）：ae515fdb-be13-3837-9717-818eb211212c
            this.orgId = '';
            // 组织path
            this.orgPath = '';
            // 用户分组id
            // 测试数据1（业务开发组2小队）：4a9ba958-ffcc-b4d3-7b56-ee235635c637
            // 测试数据2（业务开发组1组）：3ccb8215-2542-d632-2226-03d34eaa42fe
            this.userGroupId = '';
            // 外部传入的已选人员，多个用英文逗号隔开
            this.userIds = '';
            // 外部传入的待选人员，多个用英文逗号隔开
            ...
            // 组织树分层加载，默认为false，行政组织未提供后端接口
            this.enableHierarchicalLoading = false;
            // 是否包含子级（组织tab页）
        ...
        */
        ...
        // 当页签≤3 个时搜索框宽度为 250,页签为 4 个时搜索框宽度为 220px,页签为 5 个时搜索框宽度为 180px。
        // todo：目前有6个tab页，都显示时如何处理
        // 当页签≤3 个时搜索框宽度为 250,页签为 4 个时搜索框宽度为 220px,页签为 5 个时搜索框宽度为 180px。
        // todo：目前有6个tab页，都显示时如何处理
        /**
         * @private
                     ...
                     */function (res) {
                        ...
                        if (!_this.shownOrgId || _this.shownOrgId === '*') {
                            ...
                            if (!_this.shownOrgPath) {
                                try {
                                    for (var _b = __values(_this.originalTreeData.data), _c = _b.next(); !_c.done; _c = _b.next()) {
                                        var item = _c.value;
                                        if (item.orgId === _this.shownOrgId) {
                                            _this.shownOrgPath = item.path;
                                            break;
                                        }
                                    }
                                }
                             ...
                             */function (item) {
                                ...
                                if (_this._isInArray(item.path, 'path', pathList_1)) {
                                    filterOrg.push(item);
                                }
                            }));
                        }
                         ...
                         */function (org) {
                            org.selectable = true;
                            if (!_this._isInArray(org[_this.orgIdField], _this.orgIdField, _this.originalTreeData.data)) {
                                _this.originalTreeData.data.push(org);
                            }
                        }));
            ...
            function (node) {
                ...
                if (this.enableHierarchicalLoading) {
                     ...
                     */function (resData) {
                        ...
                        _this.cdRef.detectChanges();
                        _this.expandSysUserGroupTreeNode(_this.sysUserGroupTreeListData, pathArr, Number(node.layer));
                        _this.sysUserGroupTree.selectNode(node['id']);
        ...
        PersonnelSelectorComponent.prototype.initDisplayTab =
            ...
            function () {
                ...
                // 暂不开启群组功能
                // const allTabIdsArray = this.allTabIds.split(',').filter(item => item !== this.groupTabId);
                // this.allTabIds = allTabIdsArray.join(',');
                // 启用群组功能扩展函数
            ...
            function (parentNode) {
                 ...
                 */function (resData) {
                    if (resData && resData.length) {
                        ...
                        /** @type {?} */
                        var nodes = _this.dealSysUserGroupData(newDatas_2, '');
            ...
            function () {
                 ...
                 */function (res) {
                    ...
                    if (res && res.curAbsUser && res.curAbsUser.orgAllPathInfo && (!_this.orgId || _this.orgId === '*')) {
                         ...
                         * @return {?}
                         */function (item) {
                            if (!_this._isInArray(item[_this.orgIdField], _this.orgIdField, res.data)) {
                                res.data.push(item);
                            }
                        }));
                    }
                    _this.treeListData = _this.dataToTree(res.data, 1, currentOrgPath ? currentOrgPath : res.curAbsUser.defaultOrgPath);
                    _this.orgIdOrg = res.curAbsUser.defaultOrgId;
                    _this.pathOrg = res.curAbsUser.defaultOrgPath;
                    _this.orgId = _this.orgId ? _this.orgId : res.curAbsUser.defaultOrgId;
                    _this.path = _this.orgPath ? _this.orgPath : res.curAbsUser.defaultOrgPath;
                    _this.initFavorites();
                    _this.datagridLoad();
                    _this.cdRef.detectChanges();
        ...
        PersonnelSelectorComponent.prototype.assembleTreeData =
            ...
            function () {
                 ...
                 */function (res) {
                    ...
                    _this.orgId = _this.orgId ? _this.orgId : res.curAbsUser.defaultOrgId;
                    _this.path = _this.orgPath ? _this.orgPath : res.curAbsUser.defaultOrgPath;
                    _this.currentUserId = res.curAbsUser.userId;
                    _this.initFavorites();
                    _this.datagridLoad();
                    _this.cdRef.detectChanges();
                    if (_this.orgId == '*' || _this.orgId == '') {
                        ...
                        _this.farrisTree['cdRef']['detectChanges']();
                    }
                    else {
                        _this.farrisTree.selectNode(_this.orgId);
                    }
            ...
            function () {
                 ...
                 */function (resData) {
                    ...
                    if (!!_this.userGroupId && _this.userGroupId !== '*') {
                        ...
                        _this.sysUserGroupTree.selectNode(_this.sysUserGroupTreeListData[0].data.id);
                    }
                }));
            };
        ...
        */
        ...
        // 返回已经该节点是否展开过
        // 通过搜索定位组织树（用户分组树）的某个节点时，并且是分层加载的情况下才会被调用
        // 返回已经该节点是否展开过
        // 通过搜索定位组织树（用户分组树）的某个节点时，并且是分层加载的情况下才会被调用
        /**
         * @private
            ...
            function (data, userPath) {
                ...
                if (data.length) {
                     ...
                     */function (item) {
                        ...
                        if (_this._isInArray(item.path, 'path', userPathList) || expanded[0]) {
        ...
        PersonnelSelectorComponent.prototype.hlSysUserGroupDealData =
            ...
            function (data, path) {
                ...
                for (var a = 0; a < maxLength; a++) {
                    userPathList.push({ path: path.substring(0, 4 * (a + 1)) });
                }
                /** @type {?} */
                var newDatas = [];
                if (data.length) {
                     ...
                     */function (item) {
                        ...
                        /** @type {?} */
                        var expanded = [];
                        _this.nodeExpanded(newsDataObj, _this.sysUserGroupTreeListData, expanded);
                        if (_this._isInArray(item.path, 'path', userPathList) || expanded[0]) {
                            newsDataObj.expanded = true;
                        }
                        else {
        ...
        PersonnelSelectorComponent.prototype.farrisDialogshow =
            ...
            function () {
                ...
                if ((!!this.userIds && this.userIds.includes(',') && !this.multiSelect) || (this.selections.length > 1 && !this.multiSelect)) {
                    this.msgService.show('warning', '单选模式下预置了多条选中数据，请修改！', {
                        height: 140,
                        showHeader: false
                    });
                    return;
                ...
                if (!this.hasSetGlobalConfigParam) {
                     ...
                     */function (res) {
                        if (res) {
                            _this.setGlobalConfigParam(res);
            ...
            function () {
                ...
                if (this.initLoadTreeData === true) {
                    ...
                    if (this.enableHierarchicalLoading) {
                        ...
                        this.assembleSysUserGroupTreeData();
                    }
                }
                else {
                    this.initFavorites();
        ...
        PersonnelSelectorComponent.prototype.mapFields2Component =
            ...
            function () {
                ...
                if (!helpFields.includes(this.idField)) {
                    console.warn('选中组件数据，需要映射组件idField');
                    return;
                }
                if (this.ngControl &&
        ...
        PersonnelSelectorComponent.prototype.checkDisplayTab =
            ...
            function () {
                if (this.allTabIds && this.allTabIds !== '') {
                    ...
                    this.showGroupTab = !(this.allTabIds.indexOf(this.groupTabId) == -1);
                }
            };
