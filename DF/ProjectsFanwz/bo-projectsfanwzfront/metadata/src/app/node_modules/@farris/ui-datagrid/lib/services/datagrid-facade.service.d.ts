...
export declare class DatagridFacadeService {
    ...
    checkRow(rowIndex: number, rowData: any): void;
    unCheckRow(rowIndex: number, rowData: any): void;
    ...
    selectRow(rowIndex: number, rowData: any): void;
    private selectRowForMulti;
    private unSelectRowForMulti;
    unSelectRow(rowIndex: number, rowData: any): void;
    ...
    getColumnIndex(field: string, fixed?: 'right' | '' | 'left'): number;
