(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/platform-browser'), require('@angular/forms'), require('quill'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-html-editor', ['exports', '@angular/common', '@angular/platform-browser', '@angular/forms', 'quill', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-html-editor'] = {}),global.ng.common,global.ng.platformBrowser,global.ng.forms,global.Quill,global.ng.core));
}(this, (function (exports,common,platformBrowser,forms,Quill,core) { 'use strict';
