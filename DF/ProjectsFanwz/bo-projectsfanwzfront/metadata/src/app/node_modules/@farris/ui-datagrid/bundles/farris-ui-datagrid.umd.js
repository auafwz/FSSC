(function (global, factory) {
    ...
    ***************************************************************************** */
                ...
                function () {
                    ...
                    function (eventName) {
                        ...
                        if (eventName.indexOf('X') > -1 || eventName.indexOf('Left') > -1 || eventName.indexOf('Right') > -1) {
                            ...
                            rxjs.fromEvent(_this.elementRef.nativeElement, eventType).pipe(
                            // debounceTime(20),
                            // throttle(ev => interval(20)),
                            operators.auditTime(20), // auditTime 静默指定的时间，在此时间内忽略所有发出的值，时间过后，发出最新的值
    ...
    var ScrollbarModule = /** @class */ (function () {
        ...
        ScrollbarModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        exports: [common.CommonModule, ScrollbarComponent, ScrollbarDirective]
                    },] }
        ];
    ...
    var DatagridComponent = /** @class */ (function () {
        ...
        function () {
            this.data = this.data || [];
            this.dfs.initState(__assign({}, this, { fitColumns: this.fitColumns, fit: this.fit, groupField: this._groupField }));
        };
        /**
         * @private
         * @param {?=} fitColumns
    ...
    var DatagridBodyComponent = /** @class */ (function () {
        ...
        function () {
            var _this = this;
            this.destroySubscriptions();
            this.gridSizeSubscribe = this.dfs.gridSize$.pipe(operators.debounceTime(50)).subscribe((/**
             * @param {?} state
             * @return {?}
             */
            function (state) {
    ...
    var DatagridRowDirective = /** @class */ (function () {
        ...
        function () {
            ...
            this.subscriptions.push(s1$);
            /** @type {?} */
            var s2$ = this.dg.dfs.selectRow$.pipe(operators.filter((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
        ...
        function (event) {
            ...
            if (!this.dfs.isRowSelected(rowId)) {
                ...
                if (!canendedit || canendedit.canEnd) {
                    this.dg.beforeSelect(beforEventParam).pipe(operators.delay(100)).subscribe((/**
                     * @param {?} canSelect
                     * @return {?}
                     */
                    function (canSelect) {
    ...
    var DatagridCellEditableDirective = /** @class */ (function () {
        function DatagridCellEditableDirective(injector, el, render, dg, ngZone) {
            ...
            if (!this.cellEditorCreatedSubscription) {
                this.cellEditorCreatedSubscription = this.dgs.cellEditorCreated.pipe(operators.filter((/**
                 * @param {?} __0
                 * @return {?}
                 */
                function (_a) {
        ...
        function (e) {
            ...
            switch (keyCode) {
                case 32: // SPACE
                    ...
                    break;
                case 13: // Enter
                    this.closeEditingCell().pipe(operators.debounceTime(100)).subscribe((/**
                     * @param {?} f
                     * @return {?}
                     */
                    function (f) {
    ...
    var DatagridCheckboxComponent = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var _setcheckrows = this.dg.dgs.setCheckedRows.pipe(operators.filter((/**
             * @param {?} r
             * @return {?}
             */
            function (r) {
    ...
    var DatagridCellTooltipDirective = /** @class */ (function () {
        ...
        function () {
            /** @type {?} */
            var boxSize = this.getBoxSizeObj(this.el.nativeElement);
            /** @type {?} */
            ...
            if (tooltip.width < winSize.width && tooltip.height < boxSize.top) {
                ...
                /** @type {?} */
                var elOffset = DomHandler.getOffset(this.el.nativeElement);
                /** @type {?} */
    ...
    exports.ɵj = CellTootipMessagePipe;
    exports.ɵk = FixedLeftRowsComponent;
    exports.ɵl = DatagridCheckboxComponent;
    exports.ɵm = DatagridHeaderCheckboxComponent;
    exports.ɵn = DatagridGroupRowDirective;
    exports.ɵo = DatagridCellTooltipDirective;
    exports.ɵp = AutoHeightComponent;
    exports.ɵq = RowIsSelectedPipe;
    exports.ɵr = RowIsCheckedPipe;
    exports.ɵs = ɵs;
