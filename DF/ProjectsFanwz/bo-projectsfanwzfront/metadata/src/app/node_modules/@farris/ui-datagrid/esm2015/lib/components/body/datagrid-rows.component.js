...
export class DatagridRowsComponent {
    ...
    listenEvent() {
        /** @type {?} */
        const _s3 = this.dg.dgs.setSelecedRow.subscribe((/**
         * @param {?} r
         * @return {?}
         */
        (r) => {
        ...
        /** @type {?} */
        const _s5 = this.dg.dfs.rowUpdate$.subscribe((/**
         * @param {?} row
         * @return {?}
         */
        (row) => {
