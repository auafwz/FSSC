    ...
    var BaseComboComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                rxjs.fromEvent(window, 'resize').pipe(operators.debounceTime(100), operators.throttle(( /**
                 * @param {?} ev
                 * @return {?}
                 */function (ev) { return rxjs.interval(100); })), operators.takeUntil(this.destroy$)).subscribe(( /**
                 * @return {?}
                 */function () {
         ...
         */
            function (changes) {
                ...
                if (changes.data && !changes.data.firstChange && !this.uri) {
                    ...
                    /** @type {?} */
                    var val = this.selectedValues || this.displayText;
        ...
        ComboListModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            http.HttpClientModule, uiInputGroup.InputGroupModule,
