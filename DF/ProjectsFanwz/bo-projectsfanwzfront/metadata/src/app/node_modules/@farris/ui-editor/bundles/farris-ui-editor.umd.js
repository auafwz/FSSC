(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('@angular/core'), require('@angular/common'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-editor', ['exports', '@angular/router', '@angular/core', '@angular/common', '@angular/forms'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-editor'] = {}),global.ng.router,global.ng.core,global.ng.common,global.ng.forms));
}(this, (function (exports,router,i0,common,forms) { 'use strict';
    ...
    var EditorComponent = /** @class */ (function (_super) {
         ...
         */
            function () {
                var _this_1 = this;
                /** @type {?} */
                var finalInit = __assign({}, this.init, { target: this._element, inline: this.inline, plugins: mergePlugins(this.init && this.init.plugins, this.plugins), toolbar: this.toolbar || (this.init && this.init.toolbar), height: this.height, autoresize_max_height: this.autoresizeMaxHeight, setup: ( /**
                         * @param {?} editor
                         * @return {?}
                         */function (editor) {
