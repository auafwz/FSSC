(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-common/date'), require('@farris/ui-notify'), require('@angular/animations'), require('@farris/ui-modal'), require('@angular/common'), require('@farris/ui-messager'), require('@farris/ui-area-response')) :
    typeof define === 'function' && define.amd ? define('@farris/extend-file-upload', ['exports', '@angular/core', 'rxjs', 'rxjs/operators', '@farris/ui-common/date', '@farris/ui-notify', '@angular/animations', '@farris/ui-modal', '@angular/common', '@farris/ui-messager', '@farris/ui-area-response'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['extend-file-upload'] = {}), global.ng.core, global.rxjs, global.rxjs.operators, global.date, global.uiNotify, global.ng.animations, global.uiModal, global.ng.common, global.uiMessager, global.uiAreaResponse));
}(this, (function (exports, core, rxjs, operators, date, uiNotify, animations, uiModal, common, uiMessager, uiAreaResponse) { 'use strict';
        ...
        function (val) {
            ...
            if (this.previewEnableMulti) {
                ...
                if (this.previewSelectAllBtnChecked) {
                    this.previewMultiSelected = __spread(newFormatValue);
                }
                else {
                    this.previewMultiSelected = [];
                }
    ...
    var FFileUploadModule = /** @class */ (function () {
        ...
        FFileUploadModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            common.CommonModule, uiNotify.NotifyModule, uiMessager.MessagerModule, uiAreaResponse.FAreaResponseModule, date.DateHelperModule.forRoot(), uiModal.ModalModule.forRoot()
                        ],
                        providers: [
                            FFileUploaderService,
                            {
