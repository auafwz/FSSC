...
import { Observable, Subject, of, BehaviorSubject, fromEvent } from 'rxjs';
import { FarrisTemplateDirective, CommonUtils, IdService, FarrisComponentInstanceService, FarrisCommonModule } from '@farris/ui-common';
import { Injectable, Pipe, ElementRef, Component, NgModule, EventEmitter, NgZone, Injector, Input, Output, ViewChild, defineInjectable, inject, ChangeDetectorRef, Directive, ViewEncapsulation, ChangeDetectionStrategy, Renderer2, ContentChildren, HostListener, HostBinding, Optional, Self } from '@angular/core';
...
class TreeTableComponent {
     ...
     * @return {?}
     */
    __multiSelectNode(event, selected = false) {
        /** @type {?} */
     ...
     * @return {?}
     */
    cascadeCheckedNode(rowNode, checked) {
        /** @type {?} */
        const nodes = [];
     ...
     * @return {?}
     */
    toggleExpand(treeNode, deep = false) {
        if (treeNode) {
    ...
    onColumnResizeEnd(event, column) {
        ...
        /** @type {?} */
        const resizeColumnIndex = this.columns.findIndex((/**
         * @param {?} n
         * @return {?}
         */
        n => n.id === column.id));
        ...
        if (this.selectedRow) {
            ...
            if (!result) {
                ...
                if (rowNode.parents && rowNode.parents.length) {
                    ...
                    pid => {
                        /** @type {?} */
                        const top = this.state.rowNodes.filter((/**
                         * @param {?} n
                         * @return {?}
                         */
    ...
    checkAllNodes(args) {
        /** @type {?} */
        const rowNodes = this.state.rowNodes.filter((/**
         * @param {?} n
         * @return {?}
         */
