(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('date-fns'), require('moment'), require('immutable'), require('@angular/forms'), require('validator'), require('@angular/common/http'), require('@angular/router'), require('@farris/expression-engine'), require('bignumber.js'), require('rxjs/operators'), require('rxjs'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@farris/devkit', ['exports', 'date-fns', 'moment', 'immutable', '@angular/forms', 'validator', '@angular/common/http', '@angular/router', '@farris/expression-engine', 'bignumber.js', 'rxjs/operators', 'rxjs', '@angular/core'], factory) :
    (factory((global.farris = global.farris || {}, global.farris.devkit = {}),global.dateFns,global.moment,global.immutable,global.ng.forms,global.ValidatorJS,global.ng.common.http,global.ng.router,global.expressionEngine,global.bignumber_js,global.rxjs.operators,global.rxjs,global.ng.core));
}(this, (function (exports,dateFns,moment,immutable,forms,ValidatorJS,http,router,expressionEngine,bignumber_js,operators,rxjs,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var Form = /** @class */ (function (_super) {
        ...
        * 新增FormControls
        ...
        Form.prototype.setUpBindingDataPipeline = function (control, bindingFieldPath, converter) {
            ...
            // 设置初始值
            // BindingData => control
            this.bindingData.changes.pipe(operators.filter(function (change) {
    ...
    var AppContext = /** @class */ (function (_super) {
            ...
            if (this.parent && this.parent !== this) {
                ...
                messager_1.listner(function (msg) {
                    ...
                    if (data.command === 'wf-required-verification') { // 工作流的必填校验
                        // 注入ValidationHandler
                        var validation = _this.injector.get(VALIDATION_HANDLER, null, core.InjectFlags.Optional);
                        if (validation) {
                    ...
                    if (resultTask_1) {
                        resultTask_1.pipe(operators.throwIfEmpty()).subscribe(function (result) {
                            // 向来源方回传消息
        ...
        AppContext.prototype.findHandler = function (contextMap, command) {
            var func;
            var temp = __spread(contextMap.values());
            // tslint:disable-next-line: forin
            for (var v in temp) {
    ...
    var FrameContext = /** @class */ (function (_super) {
        ...
        FrameContext.prototype.registerExceptionHandler = function () {
            ...
            if (this.exceptionHandler !== null) {
                ...
                if (this.eventBus !== null && this.isRootFrameContext()) {
                    ...
                    this.eventBus.on('Exception', '', 'onException', this.getFormAppContext(), function (error) {
         ...
         * 销毁FrameContext
         */
        FrameContext.prototype.destroy = function () {
