(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@farris/ui-common/number'), require('@farris/ui-treetable'), require('@progress/kendo-angular-dropdowns'), require('@farris/ui-combo-list'), require('@farris/ui-multi-select'), require('@farris/ui-list-view'), require('lodash-es'), require('@farris/ui-html-editor'), require('@farris/ui-datagrid'), require('@farris/extend-file-upload'), require('rxjs'), require('@farris/discussion-group'), require('rxjs/operators'), require('primeng/treetable'), require('@farris/ui-common/date'), require('@farris/ui-editor'), require('@gsp-cmp/querysolution'), require('@farris/ui-datepicker'), require('@farris/ui-number-spinner'), require('@farris/ui-time-picker'), require('@farris/ui-text'), require('@farris/ui-combo-lookup'), require('@farris/ui-lookup'), require('@gsp-svc/formdoc-upload'), require('@farris/ui-locale'), require('@farris/ui-common/column'), require('@farris/devkit'), require('bignumber.js'), require('moment'), require('@farris/ui-dialog'), require('@angular/core'), require('@angular/common'), require('@progress/kendo-angular-grid'), require('@farris/ui-common')) :
    typeof define === 'function' && define.amd ? define('@farris/kendo-binding', ['exports', '@farris/ui-common/number', '@farris/ui-treetable', '@progress/kendo-angular-dropdowns', '@farris/ui-combo-list', '@farris/ui-multi-select', '@farris/ui-list-view', 'lodash-es', '@farris/ui-html-editor', '@farris/ui-datagrid', '@farris/extend-file-upload', 'rxjs', '@farris/discussion-group', 'rxjs/operators', 'primeng/treetable', '@farris/ui-common/date', '@farris/ui-editor', '@gsp-cmp/querysolution', '@farris/ui-datepicker', '@farris/ui-number-spinner', '@farris/ui-time-picker', '@farris/ui-text', '@farris/ui-combo-lookup', '@farris/ui-lookup', '@gsp-svc/formdoc-upload', '@farris/ui-locale', '@farris/ui-common/column', '@farris/devkit', 'bignumber.js', 'moment', '@farris/ui-dialog', '@angular/core', '@angular/common', '@progress/kendo-angular-grid', '@farris/ui-common'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['kendo-binding'] = {}),global.number,global.uiTreetable,global.kendoAngularDropdowns,global.uiComboList,global.uiMultiSelect,global.uiListView,global.lodashEs,global.uiHtmlEditor,global.uiDatagrid,global.extendFileUpload,global.rxjs,global.discussionGroup,global.rxjs.operators,global.treetable,global.date,global.uiEditor,global.querysolution,global.uiDatepicker,global.uiNumberSpinner,global.uiTimePicker,global.uiText,global.uiComboLookup,global.uiLookup,global.formdocUpload,global.uiLocale,global.column,global.devkit,global.bignumber_js,global.moment,global.uiDialog,global.ng.core,global.ng.common,global.kendoAngularGrid,global.uiCommon));
}(this, (function (exports,number,uiTreetable,kendoAngularDropdowns,uiComboList,uiMultiSelect,uiListView,lodashEs,uiHtmlEditor,uiDatagrid,extendFileUpload,rxjs,discussionGroup,operators,treetable,date,uiEditor,querysolution,uiDatepicker,uiNumberSpinner,uiTimePicker,uiText,uiComboLookup,uiLookup,formdocUpload,uiLocale,column,devkit,bignumber_js,moment,uiDialog,core,common,kendoAngularGrid,uiCommon) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var FarrisDatagridUseBindingDataDirective = /** @class */ (function () {
        ...
        FarrisDatagridUseBindingDataDirective.prototype.shouldComponentUpdate = function (change, data) {
            ...
            if (this.viewModel.frameContext.appContext.runMode === devkit.RunMode.highSpeed && change) {
        ...
        FarrisDatagridUseBindingDataDirective.prototype.updateData = function (change) {
            ...
            // 强制加载当前表数据
            if (change.type === devkit.ChangeType.SelectionChanged && isQueryChild) {
        ...
        EditableDirective.prototype.handleBeginEditEvent = function () {
            ...
            this.beginEditSubscription = this.grid.beginEdit.subscribe(function (e) {
                ...
                if (column$$1 && column$$1.editor) {
                    ...
                    if (column$$1.editor.type === 'lookup' || column$$1.editor.type === 'PersonnelSelector' || column$$1.editor.type === 'external-integration') {
