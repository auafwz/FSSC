(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@gsp-svc/file-viewer'), require('@gsp-svc/formdoc-upload'), require('@farris/extend-file-upload'), require('rxjs'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@farris/extend-fileupload-adapt-unifile', ['exports', '@angular/core', '@gsp-svc/file-viewer', '@gsp-svc/formdoc-upload', '@farris/extend-file-upload', 'rxjs', '@angular/common'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['extend-fileupload-adapt-unifile'] = {}), global.ng.core, global.fileViewer, global.formdocUpload, global.extendFileUpload, global.rxjs, global.ng.common));
}(this, (function (exports, core, fileViewer, formdocUpload, extendFileUpload, rxjs, common) { 'use strict';
