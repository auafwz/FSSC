(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-common/number'), require('@farris/ui-common/date')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-text', ['exports', '@angular/forms', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-common/number', '@farris/ui-common/date'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-text'] = {}),global.ng.forms,global.ng.core,global.ng.common,global.uiLocale,global.number,global.date));
}(this, (function (exports,forms,i0,common,uiLocale,number,date) { 'use strict';
