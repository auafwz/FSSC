(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common/http'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-input-group'), require('@farris/ui-treetable'), require('@farris/ui-dialog'), require('@farris/ui-tabs'), require('@farris/ui-perfect-scrollbar'), require('@farris/ui-avatar'), require('@angular/core'), require('lodash-es'), require('rxjs'), require('rxjs/operators'), require('@farris/ui-messager'), require('@farris/command-services')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-organization-selector', ['exports', '@angular/common/http', '@angular/common', '@angular/forms', '@farris/ui-input-group', '@farris/ui-treetable', '@farris/ui-dialog', '@farris/ui-tabs', '@farris/ui-perfect-scrollbar', '@farris/ui-avatar', '@angular/core', 'lodash-es', 'rxjs', 'rxjs/operators', '@farris/ui-messager', '@farris/command-services'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-organization-selector'] = {}),global.ng.common.http,global.ng.common,global.ng.forms,global.uiInputGroup,global.uiTreetable,global.uiDialog,global.uiTabs,global.uiPerfectScrollbar,global.uiAvatar,global.ng.core,global._,global.rxjs,global.rxjs.operators,global.uiMessager,global.commandServices));
}(this, (function (exports,http,common,forms,uiInputGroup,uiTreetable,uiDialog,uiTabs,uiPerfectScrollbar,uiAvatar,core,_,rxjs,operators,uiMessager,commandServices) { 'use strict';
    ...
    var GroupComponent = /** @class */ (function () {
        ...
        GroupComponent.prototype.deleteGroup =
            ...
            function (e, item) {
                var _this = this;
                this.formMessageService.confirm("是否删除此群组？").pipe(operators.switchMap(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
                    if (!!result) {
        ...
        GroupComponent.prototype.removeOrg =
            ...
            function (e, data) {
                var _this = this;
                this.formMessageService.confirm("是否将此组织移出当前群组？").pipe(operators.switchMap(( /**
                 * @param {?} result
                 * @return {?}
                 */function (result) {
                    if (!!result) {
        ...
        GroupComponent.ctorParameters = function () {
            return [
                ...
                { type: core.ChangeDetectorRef },
                { type: core.Injector },
                { type: commandServices.FormMessageService },
                { type: commandServices.FormLoadingService }
            ];
        };
        ...
        OrganizationSelectorModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            commandServices.CommandServicesModule
                        ],
