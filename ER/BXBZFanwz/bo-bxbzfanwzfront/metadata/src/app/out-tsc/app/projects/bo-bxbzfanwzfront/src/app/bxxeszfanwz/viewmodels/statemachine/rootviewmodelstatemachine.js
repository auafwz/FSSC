...
var ɵ0 = function (context) { return context.state === 'add' || context.state === 'edit' || context.state === 'init'; }, ɵ1 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ2 = function (context) { return context.state === 'init'; }, ɵ3 = function (context) { return context.state === 'add' || context.state === 'init'; }, ɵ4 = function (context) { return context.state === 'add' || context.state === 'edit'; }, ɵ5 = function (context) { return context.state === 'add' || context.state === 'edit'; };
