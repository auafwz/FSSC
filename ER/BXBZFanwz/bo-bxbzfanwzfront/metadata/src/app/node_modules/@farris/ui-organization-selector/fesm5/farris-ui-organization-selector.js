...
import { Injectable, Component, Input, ChangeDetectorRef, Injector, ViewChild, HostBinding, NgZone, EventEmitter, Output, forwardRef, Renderer2, NgModule } from '@angular/core';
import { cloneDeep } from 'lodash-es';
import { FormMessageService, FormLoadingService, CommandServicesModule } from '@farris/command-services';
...
var OrganizationSelectorComponent = /** @class */ (function () {
    ...
    function (e) {
        if (e.nextId === this.groupTabId) {
            ...
            this.libOrgGroup.selections = cloneDeep(this.selections);
...
export { ApiService, FavoritesTool, StateMgrTool, OrganizationSelectorComponent, OrganizationSelectorModule, OrganizationComponent, SearchComponent, SelectionComponent, FavoritesComponent, AppendGroupOrgComponent as ɵb, GroupComponent as ɵa };
