...
export declare class NavigationService {
    ...
    private injector;
    constructor(runtimeFrameworkService: RuntimeFrameworkService, menuStateService: MenuStateService, navigationEventService: NavigationEventService, querystringService: QuerystringService, frameContext: FrameContext, injector: Injector);
    context: any;
    /**
     ...
     */
    openMenu(tabId: string, funcId: string, params: any, reload?: boolean, enableRefresh?: any, tabName?: string, destructuring?: any): void;
    /**
     * 打开菜单（流）
     * @param tabId 根据TabId决定打开新标签页或定位之前打开的标签页
     * @param funcId 菜单Id
     ...
     * @param destructuring 解构参数
     */
    openApp(tabId: string, appId: string, appEntrance: string, params: any, reload?: boolean, tabName?: string, enableRefresh?: any, destructuring?: any): void;
    /**
     * 打开应用(流式)
     * @param tabId tabId 根据TabId决定打开新标签页或定位之前打开的标签页
     * @param appId 应用Id
