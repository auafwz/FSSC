(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@farris/ui-common'), require('@angular/forms'), require('@farris/ui-messager'), require('@angular/platform-browser'), require('@angular/core'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-forms', ['exports', '@angular/common', '@farris/ui-common', '@angular/forms', '@farris/ui-messager', '@angular/platform-browser', '@angular/core', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-forms'] = {}),global.ng.common,global.uiCommon,global.ng.forms,global.uiMessager,global.ng.platformBrowser,global.ng.core,global.uiLocale));
}(this, (function (exports,common,uiCommon,forms,uiMessager,platformBrowser,core,uiLocale) { 'use strict';
