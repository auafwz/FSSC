(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('rxjs/operators'), require('resize-observer-polyfill'), require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@farris/ui-locale')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-tabs', ['exports', 'rxjs', 'rxjs/operators', 'resize-observer-polyfill', '@angular/core', '@angular/common', '@angular/forms', '@farris/ui-locale'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-tabs'] = {}),global.rxjs,global.rxjs.operators,global.ResizeObserver,global.ng.core,global.ng.common,global.ng.forms,global.uiLocale));
}(this, (function (exports,rxjs,operators,ResizeObserver,core,common,forms,uiLocale) { 'use strict';
            ...
            function () {
                 ...
                 */function (curBtn, index) {
                     ...
                     */function (event) {
                        ...
                        /** @type {?} */
                        var interval$ = rxjs.of(0).pipe(operators.concat(rxjs.interval(80)), operators.takeUntil(mouseup$), operators.scan(( /**
                         * @param {?} sum
                         * @param {?} num
                         * @return {?}
                         */function (sum, num) {
