...
import { ControlType, QueryCondition } from '@farris/component-querycondition';
...
import { AppContext, FrameEventBus, RouterParamService, UID, FrameContext, TranslateToken, ViewModel, Repository, PARENT_CLASS, ChangeType, StateMachine, BindingData, BindingList, EntityPathConverter, FieldMetadataUtil, BindingPathConverter, DataPathCreator, AppContextManager, UserSettingsToken, Entity, EntityList, FORM_PATH_TOKEN, FORM_MANIFEST_SERVICE_TOKEN, ENTITY_TEMPLATE, ResolveService, ExpressionUtil, ExpressionExecutor, DataPropGroup, FORM_EXPRESSION_MANIFEST_SERVICE_TOKEN, MESSAGE_SERVICE_TOKEN, NOTIFY_SERVICE_TOKEN, FRAME_COMPONENT_INIT_HANDLER_TOKEN } from '@farris/devkit';
            ...
            exception: {
                ...
                copyButton: {
                    ...
                    onClick: (e) => {
                        ...
                        const frameContext = error && error['__frame_context__'];
                        if (frameContext) {
...
class NavigationService {
    constructor(runtimeFrameworkService, menuStateService, navigationEventService, querystringService, frameContext, injector) {
        this.runtimeFrameworkService = runtimeFrameworkService;
        this.menuStateService = menuStateService;
    ...
    get params() {
        ...
        */
        ...
        this.runtimeFrameworkService.addEventListener(tabId, (e) => {
            ...
            setTimeout(() => {
                subject.next(Object.assign({}, e, map$$1, params));
            }, 0);
        }, params);
