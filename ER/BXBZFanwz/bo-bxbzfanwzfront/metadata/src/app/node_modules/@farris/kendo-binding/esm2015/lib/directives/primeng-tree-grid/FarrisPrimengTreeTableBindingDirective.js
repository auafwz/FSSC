    ...
    */
    ...
    onEditCompleteHandler(event) {
        ...
        if (event && event.hasOwnProperty('data')) {
            ...
            const bindingData = this.bindingData.getValue(bindingPaths);
            const oldValue = this.getValue(fieldName, bindingData);
    ...
    updateBindingList(primaryValue, propertyName, value) {
        ...
        if (propertyNames.length < 2) {
            ...
            // todo:需要添加值变化事件
            targetBindingObject.setValue(targetPropertyName, value, true, true, this.bindingData.getValudChangeInvokerFactory()(paths));
        }
    }
    getBindingPathArray() {
