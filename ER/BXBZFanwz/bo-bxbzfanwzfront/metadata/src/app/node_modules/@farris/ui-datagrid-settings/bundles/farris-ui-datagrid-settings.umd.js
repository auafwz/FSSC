(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('rxjs'), require('@angular/core'), require('@farris/ui-modal'), require('@farris/ui-messager'), require('@farris/ui-locale'), require('lodash-es'), require('@farris/ui-common'), require('@farris/ui-multi-select'), require('@angular/forms'), require('@angular/common'), require('@farris/ui-datagrid'), require('@farris/smooth-dnd'), require('@farris/ui-combo-list')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datagrid-settings', ['exports', 'rxjs/operators', 'rxjs', '@angular/core', '@farris/ui-modal', '@farris/ui-messager', '@farris/ui-locale', 'lodash-es', '@farris/ui-common', '@farris/ui-multi-select', '@angular/forms', '@angular/common', '@farris/ui-datagrid', '@farris/smooth-dnd', '@farris/ui-combo-list'], factory) :
    (global = global || self, factory((global.farris = global.farris || {}, global.farris['ui-datagrid-settings'] = {}), global.rxjs.operators, global.rxjs, global.ng.core, global.uiModal, global.uiMessager, global.uiLocale, global.lodashEs, global.uiCommon, global.uiMultiSelect, global.ng.forms, global.ng.common, global.uiDatagrid, global.smoothDnd, global.uiComboList));
}(this, function (exports, operators, rxjs, core, uiModal, uiMessager, uiLocale, lodashEs, uiCommon, uiMultiSelect, forms, common, uiDatagrid, smoothDnd, uiComboList) { 'use strict';
