(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/forms'), require('@angular/core'), require('@angular/common'), require('@farris/ui-locale'), require('@farris/ui-input-group')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-language-textbox', ['exports', 'rxjs', '@angular/forms', '@angular/core', '@angular/common', '@farris/ui-locale', '@farris/ui-input-group'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-language-textbox'] = {}),global.rxjs,global.ng.forms,global.ng.core,global.ng.common,global.uiLocale,global.uiInputGroup));
}(this, (function (exports,rxjs,forms,i0,common,uiLocale,uiInputGroup) { 'use strict';
