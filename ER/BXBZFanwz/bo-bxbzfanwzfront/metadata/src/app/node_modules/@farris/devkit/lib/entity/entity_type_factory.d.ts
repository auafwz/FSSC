...
export declare class EntityTypeFactory {
    ...
    create(schema: Schema): {
        ...
        prototype: {
            ...
            validate(propertyName?: string, value?: any, externalRules?: Map<string, import("./validator").ValidateRule[]>, index?: number): import("rxjs").Observable<import("./validator").ValidationResult>; /** 原始字段名称 */
