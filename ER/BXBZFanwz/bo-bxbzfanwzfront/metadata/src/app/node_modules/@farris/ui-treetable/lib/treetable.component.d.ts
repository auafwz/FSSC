...
export declare class TreeTableComponent implements OnInit, AfterContentInit, AfterViewInit, OnChanges, AfterViewChecked, OnDestroy {
     ...
     */
    toggleExpand(treeNode?: TreeNode, deep?: boolean): void;
    private toggleVisible;
    /** 展开指定节点 */
    expandNode(id: string, emit?: boolean): void;
    /** 展开所有节点 */
    expandAll(): void;
 ...
 * 表体checkbox 组件
 */
export declare class TreeTableCheckboxComponent implements OnInit {
    tt: TreeTableComponent;
    ttService: TreetableService;
    cls1: boolean;
    checked: boolean;
...
export declare class TTResizableColumnDirective implements AfterViewInit, OnDestroy {
    tt: TreeTableComponent;
    ngzone: NgZone;
    el: ElementRef;
    render: Renderer2;
