(function (global, factory) {
    ...
    (factory((global.farris = global.farris || {}, global.farris['ui-lookup'] = {}),global.uiShortcuts,global.types,global.lodashEs,global.rxjs,global.ng.platformBrowser,global.ng.common,global.ng.forms,global.uiCommon,global.uiLayout,global.uiDialog,global.uiMessager,global.uiDatatable,global.uiTreetable,global.uiLoading,global.ng.animations,global.ng.core,global.uiInputGroup,global.rxjs.operators,global.uiLocale,global.uiNotify));
}(this, (function (exports,uiShortcuts,types,lodashEs,rxjs,platformBrowser,common,forms,uiCommon,uiLayout,uiDialog,uiMessager,uiDatatable,uiTreetable,uiLoading,animations,core,uiInputGroup,operators,uiLocale,uiNotify) { 'use strict';
            ...
            function (event, type) {
                 ...
                 */function (c) {
                    ...
                    if (_this.ins.activeTab === 'datalist') {
                        ...
                        if (!favIds || !favIds.length) {
                            return _this.getData(event, type).pipe(operators.map(( /**
                             * @param {?} r
                             * @return {?}
                             */function (r) {
                                if (r) {
    ...
    var LookupGridComponent = /** @class */ (function (_super) {
                ...
                if (canSelect) {
                    ...
                    if (!this.singleSelect && this.enableCascade && this.isTree() &&
                        ...
                        if (parentsIds && parentsIds.length) {
                            ...
                            this.showLoading();
                            selectedRows$ = this.httpMgr.getData({ parentsIds: parentsIds }, 'allChildren').pipe(operators.map(( /**
                             * @param {?} r
                             * @return {?}
                             */function (r) {
                                /** @type {?} */
        ...
        LookupGridComponent.decorators = [
            { type: core.Component, args: [{
                        ...
                        providers: [LOOKUPGRID_VALUE_ACCESSOR, uiShortcuts.ShortcutsService, LookupDefaultMapping, LookupUtils, PersonalConfigService],
    ...
    var LookupModule = /** @class */ (function () {
        ...
        LookupModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        providers: [],
                        entryComponents: [uiDatatable.DataTableComponent, uiTreetable.TreeTableComponent, LookupLeftComponent, LookupTabsComponent]
                    },] }
        ];
        return LookupModule;
    }());
