(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/animations'), require('rxjs/operators'), require('rxjs'), require('date-fns'), require('@farris/ui-locale'), require('@angular/common'), require('@angular/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-time-picker', ['exports', '@angular/animations', 'rxjs/operators', 'rxjs', 'date-fns', '@farris/ui-locale', '@angular/common', '@angular/core', '@angular/forms'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-time-picker'] = {}),global.ng.animations,global.rxjs.operators,global.rxjs,global.dateFns,global.i1,global.ng.common,global.ng.core,global.ng.forms));
}(this, (function (exports,animations,operators,rxjs,dateFns,i1,common,i0,forms) { 'use strict';
