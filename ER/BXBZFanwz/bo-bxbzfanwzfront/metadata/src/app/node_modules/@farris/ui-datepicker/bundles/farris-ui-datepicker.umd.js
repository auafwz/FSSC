(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('lodash-es'), require('@angular/forms'), require('date-fns'), require('@angular/core'), require('@farris/ui-time-picker'), require('@farris/ui-locale'), require('@farris/ui-popover'), require('@farris/ui-common/date'), require('@farris/ui-notify')) :
    typeof define === 'function' && define.amd ? define('@farris/ui-datepicker', ['exports', '@angular/common', 'lodash-es', '@angular/forms', 'date-fns', '@angular/core', '@farris/ui-time-picker', '@farris/ui-locale', '@farris/ui-popover', '@farris/ui-common/date', '@farris/ui-notify'], factory) :
    (factory((global.farris = global.farris || {}, global.farris['ui-datepicker'] = {}),global.ng.common,global.lodashEs,global.ng.forms,global.dateFns,global.ng.core,global.uiTimePicker,global.uiLocale,global.uiPopover,global.date,global.uiNotify));
}(this, (function (exports,common,lodashEs,forms,dateFns,core,uiTimePicker,uiLocale,uiPopover,date,uiNotify) { 'use strict';
            ...
            function (str, ignorRange) {
                ...
                function convert(v, _getValue, originTime) {
                    ...
                    if (showTime) {
                        ...
                        /** @type {?} */
                        var time = v.split(' ')[1];
                        dateValue = _getValue(date$$1, dateFormat, delimeters);
                        if (time) {
                    ...
                    if (this.dateFormat.indexOf('yyyy') === -1 || this.dateFormat.indexOf('dd') === -1) {
                        ...
                        if (this._realValue) {
                            if (this.returnType === 'Date') {
                                ...
                                return dateFns.isValid(new Date(this._convert2dateString(this._realValue)));
                            }
                        }
                        /** @type {?} */
    ...
    var FarrisDatePickerModule = /** @class */ (function () {
        ...
        FarrisDatePickerModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [
                            common.CommonModule, forms.FormsModule, uiTimePicker.TimePickerModule, uiLocale.LocaleModule, uiPopover.PopoverModule.forRoot(),
                            date.DateHelperModule.forRoot(), uiNotify.NotifyModule.forRoot(),
                        ],
                        declarations: [
                            CalendarComponent,
