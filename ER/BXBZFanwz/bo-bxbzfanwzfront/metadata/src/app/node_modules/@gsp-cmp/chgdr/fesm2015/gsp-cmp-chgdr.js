...
import { Injectable, Injector, Component, Input, ViewChild, ChangeDetectorRef, EventEmitter, HostBinding, Output, NgModule, ComponentFactoryResolver, defineInjectable, inject, INJECTOR } from '@angular/core';
...
ChgdrListDialogContentComponent.decorators = [
    { type: Component, args: [{
                ...
                template: "<chgdr-list [entityId]=\"entityId\" [dataId]=\"dataId\" style=\"padding: 0.75rem 0.875rem;height:100%\"></chgdr-list>",
                styles: [""]
            }] }
];
/** @nocollapse */
...
class ChgdrHeaderDatagridComponent {
    ...
    ngOnChanges(changes) {
        ...
        err => {
            ...
            this.messageService.error("获取业务编号配置失败：" + ErrorUtil.getErrorMessage(err));
        }));
    }
    /**
     * 更新业务实体元数据
    ...
    resetColumnAndData(entityId, headers) {
        ...
        /** @type {?} */
        let opColumn = { title: '操作', width: 130, template: this.opCell, halign: 'center', align: 'center' };
    ...
    showChangeDetail(ctx) {
        ...
        data => {
            if (!data) {
                this.notifyService.error("未找到编号为【" + header.id + "】的变更日志");
            }
            else {
...
export { ChgdrModule$$1 as ChgdrModule, ChgdrService, ChgdrDataViewerComponent, ChgdrHeaderDatagridComponent, ChgdrListComponent, ChangeDataHeader, ChangeDataRow, OperateType, ChangeDataQueryParam, ChangeDataQueryResult, ChgdrListUiService, ChgdrListDialogContentComponent as ɵf, ChgdrRowBaseinfoFormComponent as ɵd, ChgdrRowGridComponent as ɵe, ChgdrConfigService as ɵb, ChgdrInnerService as ɵc, ChgdrMetadataService as ɵa };
