...
export declare class BifManualCreationDataWebCmpService {
     ...
     */
    executeBillCreationProcess(entities: Entity[], creationProcessId: string, creationRuleId: string, targetDataIds: string[]): Observable<FormBillCreationProcessExecutorResult>;
    /**
